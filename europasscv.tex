...
\texttt{english}, \texttt{german}, \texttt{italian}, \texttt{portuguese}.
...
The following people contributed language definition files: Peter Fink (German), Nuno Vieira (Portuguese).
\end{document}
