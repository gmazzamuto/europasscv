...
\begin{abstract}
This paper describes how to use europasscv.cls, a \LaTeX\ document class for typesetting a curriculum vitae according to the Europass initiative of the European Commission, 2013 version. This is an unofficial implementation of that format.
...
\begin{verbatim}
\documentclass[english]{europasscv}
\begin{document}
  \begin{europasscv}
  \end{europasscv}
\end{document}
